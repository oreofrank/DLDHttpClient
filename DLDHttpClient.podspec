#
#  Be sure to run `pod spec lint DLDHttpClient.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/oreofrank/DLDHttpClient.git", :tag => "1.0.2" }
  ...
  s.source_files  = "DLDHttpClientFramework/**/*.{h,m,swift}"
